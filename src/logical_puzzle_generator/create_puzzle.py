...
from logical_puzzle_generator.themes.registry import DEFAULT_THEME_REGISTRY, RANDOM_THEME_ID
...
def create_puzzle(
    ...
    puzzle = PuzzleGenerator(difficulty=difficulty, theme=theme).generate(template)
